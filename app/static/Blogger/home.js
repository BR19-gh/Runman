...
if(localStorage.getItem('isUserAdmin')==1){
  ...
  addBlogBtn.addEventListener('click',()=>{
    if(localStorage.getItem('isUserAdmin')==1){
    window.location.assign('addBlog.html'); 
    }
  });
...
let insideHome = document.getElementById("insideHome");
 ...
 document.getElementById('delCon').style.display='inline-flex';
    ...
    {document.getElementById('noNewMsg').style.display="block"; document.getElementById('delCon').style.display='none';}

function deleteArticle(){
    if(localStorage.getItem("articleArray")=="{\"titles\":[],\"details\":[],\"date\":[]}")
    {document.getElementById('noNewMsg').style.display="block"; document.getElementById('delCon').style.display='none'; return;}
